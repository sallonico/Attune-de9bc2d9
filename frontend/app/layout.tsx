...
// Attune type system — Bricolage (display), Hanken (UI/body), JetBrains Mono (device readouts).
...
export const metadata: Metadata = {
  title: "attune — care that keeps time with you",
  description: "Gentle medication reminders. The right dose at the right moment, without anxiety.",
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <body
        className={`${bricolage.variable} ${hanken.variable} ${jetbrainsMono.variable} antialiased`}
